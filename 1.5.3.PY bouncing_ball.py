...
radius_slider = Tkinter.Scale(root, from_=1, to=40, variable=radius_intvar,    
...
canvas = Tkinter.Canvas(root, width=600, height=600, background='#FABCDF')
canvas.grid(row=0, rowspan=2, column=1)


circle_item = canvas.create_oval(x-r, y-r, x+r, y+r, 
                                 outline='#000000', fill='#00FBAF')
import math
def animate():
